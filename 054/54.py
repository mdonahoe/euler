...
suits = 'HDCS'
value = 'A23456789TJQKA'

tourney = """8C TS KC 9H 4S 7D 2S 5D 3S AC
...
for r,s in replacements.iteritems(): tourney = tourney.replace(r,s)

rounds = tourney.split('\n')
rlist = []
for r in rounds
	p1 = r[:14].split(' ')
	p1.sort()
